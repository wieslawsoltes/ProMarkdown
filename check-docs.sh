...
test -f "${DOC_ROOT}/articles/reference/editing-api/index.html"
test -f "${DOC_ROOT}/articles/reference/extension-api/index.html"
test -f "${DOC_ROOT}/articles/reference/package-api/index.html"
